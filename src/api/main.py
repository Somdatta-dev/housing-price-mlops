...
class PredictionResponse(BaseModel):
    ...
    prediction: float = Field(..., description="Predicted house value in hundreds of thousands of dollars")
...
class BatchPredictionRequest(BaseModel):
    ...
    instances: List[HousingFeatures] = Field(..., description="List of housing features for batch prediction")
...
async def get_model_info():
    ...
    try:
        ...
        if hasattr(model, 'feature_importances_'):
            ...
            model_info["feature_importances"] = dict(zip(feature_names, importances_list))
