...
class PrometheusMetrics:
    ...
    def __init__(self):
        ...
        self.model_prediction_value = Histogram(
            ...
            buckets=[50000, 100000, 200000, 300000, 500000, 750000, 1000000, float('inf')],
            registry=self.registry
        )
    ...
    def record_model_prediction(self, model_name: str, prediction_value: float, 
                              inference_time: float, prediction_type: str = 'single'):
...
def record_prediction_metrics(model_name: str, prediction_value: float, inference_time: float):
    """Record prediction metrics (to be called from prediction endpoints)"""
    prometheus_metrics.record_model_prediction(model_name, prediction_value, inference_time)
