...
class TestHealthEndpoint:
    ...
    def test_health_endpoint_structure(self):
        ...
        data = response.json()
        required_fields = [
            "status", "model_loaded", "timestamp", "uptime_seconds"
        ]
...
class TestPredictionEndpoint:
    ...
    def test_predict_success(self, mock_model):
        ...
        data = response.json()
        required_fields = [
            "prediction", "prediction_id", "model_version", 
...
class TestBatchPredictionEndpoint:
    ...
    def test_batch_predict_success(self, mock_model):
        ...
        batch_data = {
            "instances": [VALID_HOUSING_DATA, VALID_HOUSING_DATA]
        }
        ...
        data = response.json()
        required_fields = [
            "predictions", "batch_id", "total_instances", 
    ...
    def test_batch_predict_too_many_instances(self):
        ...
        batch_data = {
            "instances": [VALID_HOUSING_DATA] * 101  # Exceeds limit of 100
        }
